...
import '../app/data/country.dart';
import '../app/data/phone_number.dart';
  ...
  void initState() {
    ...
    if (widget.initialCountryCode == null && number.startsWith('+')) {
      ...
      _selectedCountry = _countryList.firstWhere(
          (item) => item.code == (widget.initialCountryCode ?? 'NG'),
          orElse: () => _countryList.first);
    }
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Container(width: 1, height: 20, color: AppTheme.grey),
                SizedBox(
                  width: 8,
                ),
              ],
